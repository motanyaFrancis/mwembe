...
export default function Navbar() {
    ...
    // Detect brightness of hero background
    useEffect(() => {
            ...
            >
                <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
                    ...
                    <Link href="/">
                        {isDarkBg || scrolled ? (
                            <Image
                                src="/images/Mwembe-White.png"
                                alt="Mwembe 2026 Logo"
                                width={200}
                                height={40}
                                priority
                            />
                    ...
                    <button
                        ...
                        className={`lg:hidden ${textColor} focus:outline-none transition-colors`}
                    >
